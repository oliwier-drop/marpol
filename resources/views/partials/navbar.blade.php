<nav class="bg-white/20 backdrop-blur-sm fixed w-full z-20 top-0 start-0">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center lg:order-2">
            <div class="hidden lg:flex lg:space-x-8 rtl:space-x-reverse">
                <a href="/o-nas" class="block py-2 px-3 text-lg text-heading rounded hover:bg-neutral-tertiary lg:hover:bg-transparent lg:border-0 lg:hover:text-fg-brand lg:p-0">O nas</a>
                <a href="/produkty" class="block py-2 px-3 text-lg text-heading rounded hover:bg-neutral-tertiary lg:hover:bg-transparent lg:border-0 lg:hover:text-fg-brand lg:p-0">Produkty</a>
                <a href="/kontakt" class="block py-2 px-3 text-lg text-heading rounded hover:bg-neutral-tertiary lg:hover:bg-transparent lg:border-0 lg:hover:text-fg-brand lg:p-0">Kontakt</a>
            </div>
        </div>

        <!-- Przycisk hamburger dla mobile -->
        <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-body rounded-base lg:hidden hover:bg-neutral-secondary-soft hover:text-heading focus:outline-none focus:ring-2 focus:ring-neutral-tertiary order-4" aria-controls="navbar-default" aria-expanded="false">
