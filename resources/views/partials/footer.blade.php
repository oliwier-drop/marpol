<footer class="bg-black pt-8">
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <!-- Footer Top -->
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-12 pb-8 border-b border-white/10">
                <!-- Left -->
                <div class="space-y-4">
        ...
        <div class="pt-6 pb-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between text-sm text-white/70">
            ...
            <div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
                <a href="/regulamin" class="text-[var(--accent-color)] hover:text-white transition-colors">Regulamin</a>
                <a href="/polityka-prywatnosci" class="text-[var(--accent-color)] hover:text-white transition-colors">Polityka prywatności</a>
            </div>
