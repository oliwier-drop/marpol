...
@section('header')
    <section id="hero-video">
        ...
        {{-- Treść na wierzchu --}}
        <div class="hero-content px-4 mx-auto max-w-screen-xl min-h-screen flex flex-col items-center justify-center text-center">
            ...
            <p class="mb-8 text-base font-normal text-white md:text-xl sm:px-16 lg:px-48">W Marpol dbamy o jakość i estetykę opakowań, oferując szeroki wybór materiałów, kolorów i wzorów. Łączymy innowacyjne, wydajne procesy z ochroną środowiska naturalnego.</p>
            <!-- CTA Buttons -->
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="grid gap-10 md:grid-cols-2 items-center">
                <div class="space-y-4 md:space-y-6 text-center md:text-right md:order-2">
                    <h2 class="text-2xl md:text-3xl font-bold">Ochrona środowiska</h2>
                    <p class="text-base md:text-lg text-gray-700">
                        Stawiamy na odpowiedzialną produkcję opakowań – optymalizujemy zużycie surowców, dbamy o możliwość recyklingu
                        i wybieramy rozwiązania przyjazne dla środowiska, bez kompromisów w kwestii jakości.
                    </p>
                    <ul class="mt-4 space-y-2 text-sm md:text-base text-gray-700">
                        <li>• wykorzystanie materiałów nadających się do recyklingu</li>
                        <li>• minimalizacja odpadów w procesie produkcji</li>
                ...
                <path d="M112.5 106C93.7 133.6 84.3333 180.833 82 201C92.8333 211.667 115.5 223.5 119.5 185.5C123.5 147.5 116.5 116.667 112.5 106Z" fill="#d6e2fb"/>
                <path d="M112.5 106C93.7 133.6 84.3333 180.833 82 201C92.8333 211.667 115.5 223.5 119.5 185.5C123.5 147.5 116.5 116.667 112.5 106Z" fill="url(#paint1_linear_344_2328)"/>
                <path d="M162.999 103C149.799 124.6 154.499 137.667 158.499 141.5L235.999 161.5C273.166 159.167 347.599 151.1 347.999 137.5C348.499 120.5 341.999 91.5 312.499 82.5C282.999 73.5 279.999 57.0001 268.499 29.0001C256.999 1.0001 205.499 -13.9999 177.499 19.0001C149.499 52.0001 179.499 76.0001 162.999 103Z" fill="#374151"/>
                ...
                <path d="M93.549 340.213C67.8822 327.93 54.9683 315.73 51.7197 311.165C36.8279 310.058 12.2186 312.804 32.9152 332.652C58.786 357.461 84.6875 368.754 95.3057 368.442C105.924 368.13 125.633 355.568 93.549 340.213Z" fill="#FDBA8C"/>
                <path d="M93.549 340.213C67.8822 327.93 54.9683 315.73 51.7197 311.165C36.8279 310.058 12.2186 312.804 32.9152 332.652C58.786 357.461 84.6875 368.754 95.3057 368.442C105.924 368.13 125.633 355.568 93.549 340.213Z" fill="url(#paint7_linear_344_2328)"/>
                <path d="M93.549 340.213C67.8822 327.93 54.9683 315.73 51.7197 311.165C36.8279 310.058 12.2186 312.804 32.9152 332.652C58.786 357.461 84.6875 368.754 95.3057 368.442C105.924 368.13 125.633 355.568 93.549 340.213Z" fill="url(#paint8_linear_344_2328)"/>
                <path d="M94.9993 168.5C52.9993 209.5 40.0986 242.102 34.7128 272.5L57.6831 304.368C58.1735 305.048 58.1882 305.954 57.7456 306.667C53.3972 313.666 44.7156 331.885 38.684 358.846C38.3601 360.294 36.6444 360.914 35.5371 359.926C23.1347 348.862 2.12107 321.263 0.999385 283.5C-0.500615 233 60.9995 189.5 94.9993 168.5Z" fill="#F9FAFB"/>
                <path d="M94.9993 168.5C52.9993 209.5 40.0986 242.102 34.7128 272.5L57.6831 304.368C58.1735 305.048 58.1882 305.954 57.7456 306.667C53.3972 313.666 44.7156 331.885 38.684 358.846C38.3601 360.294 36.6444 360.914 35.5371 359.926C23.1347 348.862 2.12107 321.263 0.999385 283.5C-0.500615 233 60.9995 189.5 94.9993 168.5Z" fill="url(#paint9_linear_344_2328)"/>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M26.141 349.968C25.6242 349.333 25.1048 348.681 24.584 348.01C26.5878 340.409 29.5263 330.688 33.1406 321.158C37.4207 309.872 42.6971 298.72 48.5645 291.716L49.7729 293.392C44.2769 300.126 39.2089 310.797 35.0106 321.867C31.1898 331.942 28.1281 342.24 26.141 349.968Z" fill="#c8d8fa"/>
                ...
                <path d="M116.5 350.5C148.9 354.9 169 351.333 175 349C190 357.333 211.9 375.5 179.5 381.5C139 389 107 383.5 96.9996 376.5C86.9996 369.5 75.9996 345 116.5 350.5Z" fill="#FDBA8C"/>
                <path d="M116.5 350.5C148.9 354.9 169 351.333 175 349C190 357.333 211.9 375.5 179.5 381.5C139 389 107 383.5 96.9996 376.5C86.9996 369.5 75.9996 345 116.5 350.5Z" fill="url(#paint12_linear_344_2328)"/>
                ...
                <defs>
                <linearGradient id="paint0_linear_344_2328" x1="53.402" y1="260.203" x2="54.1068" y2="166.341" gradientUnits="userSpaceOnUse">
                ...
                <linearGradient id="paint3_linear_344_2328" x1="6.00011" y1="332.5" x2="384.5" y2="229.5" gradientUnits="userSpaceOnUse">
                <stop stop-color="#9ab7f6"/>
                <stop offset="1" stop-color="#9ab7f6" stop-opacity="0"/>
                </linearGradient>
                ...
                <linearGradient id="paint7_linear_344_2328" x1="-25" y1="251" x2="75.8454" y2="345.762" gradientUnits="userSpaceOnUse">
                <stop stop-color="#7F270F"/>
                <stop offset="1" stop-color="#7F270F" stop-opacity="0"/>
                </linearGradient>
                <linearGradient id="paint8_linear_344_2328" x1="240.5" y1="369" x2="75.8454" y2="345.762" gradientUnits="userSpaceOnUse">
                <stop stop-color="#7F270F"/>
                <stop offset="1" stop-color="#7F270F" stop-opacity="0"/>
                </linearGradient>
                <linearGradient id="paint9_linear_344_2328" x1="-91.0005" y1="-429.5" x2="126.166" y2="-402.997" gradientUnits="userSpaceOnUse">
                <stop stop-color="#9ab7f6"/>
                <stop offset="1" stop-color="#9ab7f6" stop-opacity="0"/>
                </linearGradient>
